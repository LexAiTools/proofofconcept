...
export default function TermsOfService() {
  ...
  return (
    <div className="min-h-screen bg-background">
      <Helmet>
        <title>{t('pages:meta.termsOfService.title')}</title>
        <meta name="description" content={t('pages:meta.termsOfService.description')} />
        
        {/* Open Graph */}
        <meta property="og:type" content="website" />
        <meta property="og:title" content={t('pages:meta.termsOfService.title')} />
        <meta property="og:description" content={t('pages:meta.termsOfService.description')} />
        <meta property="og:url" content={currentUrl} />
        
        {/* Twitter Card */}
        <meta name="twitter:card" content="summary" />
        <meta name="twitter:title" content={t('pages:meta.termsOfService.title')} />
        <meta name="twitter:description" content={t('pages:meta.termsOfService.description')} />
        ...
        <link rel="alternate" hrefLang="x-default" href="https://app.proof-of-concept.pl/terms-of-service" />
      </Helmet>
      <Header />
