...
export const WaitlistSection = () => {
  ...
  useEffect(() => {
    // Use the primary color from design system
    setColor('hsl(186 85% 45%)');
  }, []);
  ...
  return (
    <section className="relative flex min-h-screen w-full items-center justify-center overflow-hidden bg-gradient-hero">
      <Spotlight />
      ...
      <div className="relative z-[100] mx-auto max-w-2xl px-4 py-16 text-center">
        ...
        >
          <div className="h-6 w-6 rounded bg-gradient-primary opacity-80"></div>
          <span className="text-sm font-medium text-foreground">CorballyConcepts</span>
          <motion.div
            animate={{ x: [0, 5, 0] }}
        ...
        <motion.h1
          ...
          className="from-foreground via-foreground/80 to-foreground/40 mb-4 cursor-crosshair bg-gradient-to-b bg-clip-text text-4xl font-bold text-transparent sm:text-7xl"
        >
          Join the{' '}
        ...
        >
          Be the first to access our revolutionary AI platform.
          <br className="hidden sm:block" /> Transform your business faster than ever
          before.
        </motion.p>
        ...
        >
          <div className="border-primary/10 flex flex-col items-center justify-center rounded-xl border bg-white/5 p-4 backdrop-blur-md">
            ...
            <span className="text-muted-foreground text-xs">Enterprise Clients</span>
          </div>

          <div className="border-primary/10 flex flex-col items-center justify-center rounded-xl border bg-white/5 p-4 backdrop-blur-md">
            <ExternalLink className="text-primary mb-2 h-5 w-5" />
            <span className="text-xl font-bold text-foreground">AI-Powered</span>
            <span className="text-muted-foreground text-xs">Solutions</span>
          </div>

          <div className="border-primary/10 flex flex-col items-center justify-center rounded-xl border bg-white/5 p-4 backdrop-blur-md col-span-2 sm:col-span-1">
            ...
            {!submitted ? (
              <>
                ...
                <button
                  ...
                  className="group text-primary-foreground focus:ring-primary/50 relative overflow-hidden rounded-xl bg-gradient-primary px-8 py-4 font-semibold text-white shadow-glow transition-all duration-300 hover:shadow-glow/80 focus:ring-2 focus:outline-none active:scale-95 disabled:cursor-not-allowed disabled:opacity-50"
                >
              ...
              <motion.div
                ...
                className="border-primary/20 from-primary/10 to-primary/10 text-primary flex-1 cursor-pointer rounded-xl border bg-gradient-to-r via-transparent px-6 py-4 font-medium backdrop-blur-md transition-all duration-300 hover:shadow-glow/30 active:brightness-125"
              >
        ...
        >
          <div className="flex -space-x-3">
            {users.map((user, i) => (
              <motion.div
                ...
                className="border-background from-primary size-10 rounded-full border-2 bg-gradient-to-r to-primary-glow p-[2px]"
              >
          ...
          >
            <span className="text-primary font-semibold">500+</span> already
            joined ✨
          </motion.span>
        </motion.div>
      </div>
